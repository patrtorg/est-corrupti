# @patrtorg/est-corrupti

[![npm version](https://badge.fury.io/js/@patrtorg/est-corrupti.svg)](https://badge.fury.io/js/@patrtorg/est-corrupti)
[![downloads count](https://img.shields.io/npm/dt/@patrtorg/est-corrupti.svg)](https://www.npmjs.com/package/@patrtorg/est-corrupti)
[![github-ci](https://github.com/patrtorg/est-corrupti/actions/workflows/testing.yml/badge.svg)](https://github.com/patrtorg/est-corrupti/actions/workflows/testing.yml)
...
Next, install `@patrtorg/est-corrupti`:

```bash
npm install -D @patrtorg/est-corrupti
```
